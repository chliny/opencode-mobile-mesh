...
- **Play Store**: `me.chliny.opencode.mesh` is the package for any future store distribution.
...
### Key facts
- Package: `me.chliny.opencode.mesh`. Legacy/orphaned apps `ai.opencode.mobile` and `cc.agentlabs.opencode` — ignore them.
