...
- **Play Store**: `me.chliny.opencode.zerotier` is the package for any future store distribution.
...
### Key facts
- Package: `me.chliny.opencode.zerotier`. Legacy/orphaned apps `ai.opencode.mobile` and `cc.agentlabs.opencode` — ignore them.
