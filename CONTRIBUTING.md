...
```bash
git clone https://github.com/chliny/opencode-mobile-mesh.git
cd opencode-mobile-mesh
...
Use the [Bug Report template](https://github.com/chliny/opencode-mobile-mesh/issues/new?template=bug_report.md).
...
Use the [Feature Request template](https://github.com/chliny/opencode-mobile-mesh/issues/new?template=feature_request.md) or start a [GitHub Discussion](https://github.com/chliny/opencode-mobile-mesh/discussions) if you want to explore the idea before opening a formal issue.
...
5. Open the PR against `chliny/opencode-mobile-mesh main`. Fill in the PR template.
