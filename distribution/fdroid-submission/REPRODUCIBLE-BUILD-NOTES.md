# Reproducible Build Notes — me.chliny.opencode.mesh
...
# Full build test
fdroid build me.chliny.opencode.mesh:<versionCode> --verbose
```
...
`fdroid build me.chliny.opencode.mesh:<versionCode> --verbose` (or the fdroiddata
