# Reproducible Build Notes — me.chliny.opencode.zerotier
...
# Full build test
fdroid build me.chliny.opencode.zerotier:<versionCode> --verbose
```
...
`fdroid build me.chliny.opencode.zerotier:<versionCode> --verbose` (or the fdroiddata
