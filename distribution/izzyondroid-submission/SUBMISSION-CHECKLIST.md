...
Step-by-step guide to file the inclusion request for `me.chliny.opencode.mesh`
...
- [ ] Signed release APK (not AAB) exists and is attached to a GitHub tag
      (e.g. `https://github.com/chliny/opencode-mobile-mesh/releases/tag/v0.4.2`)
...
# Expected:
#   package: name='me.chliny.opencode.mesh' versionCode='<N>' versionName='<X.Y.Z>'
...
2. Click "New Issue"
3. Title: `Include me.chliny.opencode.mesh (OpenCode Mobile)`
...
- When mainline F-Droid MR is later accepted, comment on this issue:
  "Mainline F-Droid has accepted me.chliny.opencode.mesh — please auto-delist per policy."
...
- IzzyOnDroid repo (for badge URLs): https://apt.izzysoft.de/fdroid/index/apk/me.chliny.opencode.mesh
