...
Step-by-step guide to file the inclusion request for `me.chliny.opencode.zerotier`
...
# Expected:
#   package: name='me.chliny.opencode.zerotier' versionCode='<N>' versionName='<X.Y.Z>'
...
2. Click "New Issue"
3. Title: `Include me.chliny.opencode.zerotier (OpenCode Mobile)`
...
- When mainline F-Droid MR is later accepted, comment on this issue:
  "Mainline F-Droid has accepted me.chliny.opencode.zerotier — please auto-delist per policy."
...
- IzzyOnDroid repo (for badge URLs): https://apt.izzysoft.de/fdroid/index/apk/me.chliny.opencode.zerotier
