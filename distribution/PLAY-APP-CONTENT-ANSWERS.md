# Play Console — App content answers (me.chliny.opencode.mesh)
...
## 1. Privacy policy
- URL: publish `docs/privacy/index.html` at a URL controlled by this repository.
...
4. Once live, the public listing appears at
    `https://play.google.com/store/apps/details?id=me.chliny.opencode.mesh` — then fire
